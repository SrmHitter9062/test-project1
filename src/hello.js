...
//node hello.js "http://localhost:3000/d/gaKYS3fZk/prometheus-stats?orgId=1" admin:grafana123 output.pdf

//node hello.js "https://monitor.chargepoint.com/d/2odop7dmk/critical-service-monitoring?orgId=1" siyaram.malav@chargepoint.com:Srm-mlv@20693 output1.pdf
...
(async() => {
  ...
  console.log(" width",width_px , " and height ",height_px)
  await page.pdf({
    path: outfile,
    width: width_px + 'px',
    height: height_px + 'px',
